...
• Opening slide metadata MUST be strictly formatted as follows:
  - \title{<Appropriate Lecture Title>}
  - \author{Generated by Talexa}
  - \date{}
  - Do NOT include an \institute{} command.
  - Do NOT put a real date inside \date{}. Keep it empty.
